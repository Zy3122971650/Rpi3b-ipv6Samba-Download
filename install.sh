...
sudo apt install python3 python3-dev python3-pip samba samba-common-bin git aria2 nginx 

python3 -m pip install -i https://pypi.tuna.tsinghua.edu.cn/simple qcloudapi-sdk-python flask you-get
